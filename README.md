...
1. First, download Go from the official page (https://go.dev/doc/install)
2. After that, run the file with "go run mathing.go" through the command line

# Usage (.exe file)
1. DO NOT open the exe file directly
2. Instead, open the file through the command line
